        ...
        if ((Page.User.Identity.IsAuthenticated) && (Session.Count > 0))
        {
            if (Request.QueryString.Count != 0)
            {
                ...
                ****************************************************************************/
                                ...
                                if (indColumna == 3)
                                {
                                    ...
                                    if (indColumna == 4)
                                    {
                                        ...
                                        foreach (string Responsable in Responsables)
                                            if (Responsable != "")
                                                NuevaCelda.Text += Responsable.TrimStart() + ", ";
                                    }
                                        ...
                                        if (indColumna == 5)
                                        {
                                            ...
                                            foreach (string Ejecutante in Ejecutantes)
                                                if (Ejecutante != "")
                                                    NuevaCelda.Text += Ejecutante.TrimStart() + ", ";
                                        }
                                        #endregion
                ...
                #region Convertimos la página en documento de MS Word.

                Response.AppendHeader("Content-Type", "application/msword");
                Response.AppendHeader("Content-disposition", "attachment; filename=" + "PlanMensual_PlanificadorCorporativo.doc");
